...
/**
 * MultiSendContract_v1_1_1_Web3 is the implementation specific to the Safe contract version 1.1.1.
 *
 * This class specializes in handling interactions with the Safe contract version 1.1.1 using Web3.js v6.
 *
 * @extends MultiSendBaseContractWeb3<MultiSendContract_v1_1_1_Abi> - Inherits from SafeBaseContractWeb3 with ABI specific to Safe contract version 1.1.1.
