...
export async function getSafeProxyFactoryContractInstance(
  safeVersion: SafeVersion,
  safeProxyFactoryContract_: SafeProxyFactory_V1_1_1 | SafeProxyFactory_V1_0_0,
  contractAddress: string,
  web3Adapter: Web3Adapter,
  customContractAbi?: AbiItem | AbiItem[] | undefined
): Promise<SafeProxyFactoryContract_V1_1_1_Web3 | SafeProxyFactoryContract_V1_0_0_Web3> {
  const chainId = await web3Adapter.getChainId()
  ...
  switch (safeVersion) {
    ...
    case '1.1.1':
      return new SafeProxyFactoryContract_V1_1_1_Web3(
        safeProxyFactoryContract_ as SafeProxyFactory_V1_1_1
      )
    case '1.0.0':
      return new SafeProxyFactoryContract_V1_0_0_Web3(
        safeProxyFactoryContract_ as SafeProxyFactory_V1_0_0
      )
    default:
      throw new Error('Invalid Safe version')
  }
