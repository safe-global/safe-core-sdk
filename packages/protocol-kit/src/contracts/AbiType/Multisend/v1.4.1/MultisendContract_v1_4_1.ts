...
/**
 * Extracts the names of read-only functions (view or pure) specific to the Multisend contract version 1.4.1.
 *
 * @type {Multisend_v1_4_1_Read_Functions}
 */
export type Multisend_v1_4_1_Read_Functions =
  MultisendContractReadFunctions<MultisendContract_v1_4_1_Abi>

/**
 * Extracts the names of write functions (nonpayable or payable) specific to the Multisend contract version 1.4.1.
 *
 * @type {Multisend_v1_4_1_Write_Functions}
 */
export type Multisend_v1_4_1_Write_Functions =
  MultisendContractWriteFunctions<MultisendContract_v1_4_1_Abi>
