...
import SafeContract_V1_4_1_Web3 from './Safe/v1.4.1/SafeContract_V1_4_1_Web3_OLD'
...
> {
  ...
  switch (safeVersion) {
    case '1.4.1':
      return new SafeContract_V1_4_1_Web3(safeSingletonContract as SafeSingleton_V1_4_1)
    case '1.3.0':
