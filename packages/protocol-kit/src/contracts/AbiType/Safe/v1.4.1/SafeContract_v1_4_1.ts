...
/**
 * Extracts the names of read-only functions (view or pure) specific to the Safe contract version 1.4.1.
 *
 * @type {Safe_v1_4_1_Read_Functions}
 */
export type Safe_v1_4_1_Read_Functions = SafeContractReadFunctions<SafeContract_v1_4_1_Abi>

/**
 * Extracts the names of write functions (nonpayable or payable) specific to the Safe contract version 1.4.1.
 *
 * @type {Safe_v1_4_1_Write_Functions}
 */
export type Safe_v1_4_1_Write_Functions = SafeContractWriteFunctions<SafeContract_v1_4_1_Abi>
