 ...
 *
 * @extends MultiSendBaseContractEthers<MultiSendContract_v1_4_1_Abi> - Inherits from MultiSendBaseContractEthers with ABI specific to MultiSend contract version 1.4.1.
