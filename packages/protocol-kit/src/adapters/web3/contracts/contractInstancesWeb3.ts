...
import SafeContract_V1_1_1_Web3 from './Safe/v1.1.1/SafeContract_V1_1_1_Web3_OLD'
...
export async function getSafeContractInstance(
...
): Promise<SafeContract_V1_2_0_Web3 | SafeContract_V1_1_1_Web3 | SafeContract_V1_0_0_Web3> {
  ...
  switch (safeVersion) {
    ...
    case '1.3.0':
      ...
      return safeContract.mapToTypechainContract()
    case '1.2.0':
      return new SafeContract_V1_2_0_Web3(safeSingletonContract as SafeSingleton_V1_2_0)
    case '1.1.1':
